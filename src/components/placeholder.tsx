...
export const NotFound = ({ width = 512, height = 512, ...props }: PHProps) => (
	...
	>
		<defs>
			...
			<text id="anyhbkp5" x="30" y="160.37" font-size="20" alignment-baseline="before-edge" transform="matrix(1 0 0 1 2.7780792682926574 -10.66422442880554)" style="line-height:100%" dominant-baseline="text-before-edge">
